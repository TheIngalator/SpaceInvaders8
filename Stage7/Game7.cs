/***********************************************************************************************************************************
 * Prototype 7: Display a second window to show leader board
...
namespace Stage7
{
    public class Game7 : Game
    {
        ...
        {
            // _spriteBatch.Draw(scoreButton, new Rectangle(10, 10, sprite_w, sprite_h), new Rectangle(0, 0, sprite_w, sprite_h), Color.White);
        ...
        {
            //var leaderBoardWindow = GameWindow.CreateWindow();
        }
